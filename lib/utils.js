...
class Utils {
  ...
  static getNudgeLocals(additionalData = {}) {
    const data = {
      constantsLib
    };
  ...
  static actualEjsPath(ejsPath) {
    const actualPath = path.join(__dirname, `../views/partials/${ejsPath}.ejs`);
    return actualPath;
  }
