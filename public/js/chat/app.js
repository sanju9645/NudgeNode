...
if (document.querySelector(".chat-user-list")) {
  Array.from(document.querySelectorAll(".chat-user-list li")).forEach((item) => {
    item.addEventListener("click", () => {
      ...
      const loadingContent = `<div class="relative flex justify-center items-center w-full h-full" style="margin-top: 30% !important;">
                    <div class="flex text-center p-5">
                        <img src="/img/chat/chat-loading.png" width="160" height="160" class="p-5">
                        <h2 class="italic font-bold default-chat-page-quote text-3xl mr-5 p-5">
